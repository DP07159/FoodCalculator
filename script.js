...
function login() {
    ...
    .then(data => {
        if (data.token) {
            ...
            window.location.href = "dashboard.html"; // Weiterleitung ins Dashboard
        } else {
...
// **5️⃣ Authentifizierung beim Dashboard-Load**
function checkAuth() {
    ...
    if (!token) {
        ...
        document.getElementById("user-name").textContent = username; // Begrüßung im Dashboard
    }
}
